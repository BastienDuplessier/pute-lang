...
-file("/home/zangther/prog/pute-lang/pute_leex.xrl", 14).
...
-file("/home/zangther/prog/pute-lang/pute_leex.erl", 292).
yystate() -> 3.
...
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 45 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(1, Ics, Line, Tlen+1, 0, Tlen);
yystate(6, [C|Ics], Line, Tlen, _, _) when C >= 58 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 45 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 47 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 9 ->
    yystate(1, Ics, Line, Tlen+1, 0, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 45 ->
    yystate(1, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 45 ->
    yystate(1, Ics, Line, Tlen+1, 0, Tlen);
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 47 ->
    yystate(1, Ics, Line, Tlen+1, 0, Tlen);
...
-file("/home/zangther/prog/pute-lang/pute_leex.xrl", 7).
yyaction_0(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, string_to_number (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("/home/zangther/prog/pute-lang/pute_leex.xrl", 9).
yyaction_1(TokenChars, TokenLine) ->
